...
CHECKPOINT_PATH = Path(r"C:\Users\Daniel\repos\xylo\scripts\checkpoints\synnetqatv3_pretraining_checkpoint_epoch_2000.pt")
...
for epoch in range(2001):
    ...
    if epoch % 50 == 0:
        xylo.training.save_checkpoint(
            rf"C:\Users\Daniel\repos\xylo\scripts\checkpoints\synnetqatv3_from_checkpoint_2000_epoch_{epoch:04d}.pt",
            net,
            optimizer,
            epoch,
            this_loss,
    ...
    torch.nn.utils.clip_grad_norm_(net.parameters().astorch(), 1.0)
...
plt.title("Synnetqatv2_pretraining")